...
class EvaEmailIntegration:
    ...
    def __init__(self, eva_endpoint: Optional[str] = None):
        self.eva_endpoint = eva_endpoint or config.EVA_ENDPOINT
    ...
    def _format_eva_message(self, report_data: Dict[str, Any], report_type: str, email: str) -> str:
        ...
        if report_type == "setup":
            ...
            - Dashboard link: {config.get_dashboard_url()}
            ...
            Include dashboard link: {config.get_dashboard_url()}
        ...
        <body>
            <div class="container">
                ...
                <div class="footer">
                    ...
                    <p><a href="{config.get_dashboard_url()}">View Dashboard</a></p>
                </div>
            </div>
        </body>
        </html>
...
Dashboard: {config.get_dashboard_url()}
